...
### 📊 [Pandas 실무 데이터분석 입문](./pandas_data_analysis_introduction.md) (NEW! 🔥)
재직자를 위한 실무형 데이터 분석 교육 과정입니다. 이론, 실습 코드, 퀴즈가 포함된 완전한 학습 자료입니다.
...
**특징:**
- 📚 이론 요약 + 실습 코드 + 퀴즈 통합
- 💻 실제 데이터셋을 활용한 실습 (Superstore 판매 데이터)
- 🎯 실무 중심의 예제와 활용 사례
- ✅ 정답 숨김 기능이 있는 인터랙티브 퀴즈
- 🔍 Windows + Miniconda + VSCode (CPU 환경) 완벽 호환
